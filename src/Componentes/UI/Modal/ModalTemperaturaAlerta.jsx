...
export function ModalTemperaturaAlerta() {
  ...
  return (
    <main
      className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-4 z-50" // Asegura la posición superior
      aria-modal="true"
      role="dialog"
    >
      <section className="bg-ColorFondo h-3/4 w-4/12 rounded-3xl flex justify-center items-center shadow-lg">
