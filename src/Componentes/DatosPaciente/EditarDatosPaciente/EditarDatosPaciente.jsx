    ...
    <>
      <main className="h-screen w-full flex justify-center items-center">
        ...
        <Titulos textoTitulo="Editar Datos Del Paciente" />
            ...
            <section className="grid grid-cols-2 gap-x-20 gap-y-3  mt-8">
            <div>
            ...
            <div>
              ...
              <div>
                <Parrafos textoParrafo="Edad" className="text-sm font-medium"/>
                <InpuT type="text" className="bg-ColorFondo rounded-full p-2  transform transition-transform duration-400 hover:scale-105"/>
              </div>

              <div>
                <Parrafos textoParrafo="Genero" className="text-sm font-medium"/>
                <InpuT type="text" className="bg-ColorFondo rounded-full p-2  transform transition-transform duration-400 hover:scale-105"/>
              </div>

              <div>
                <Parrafos textoParrafo="Altura" className="text-sm font-medium"/>
                <InpuT type="text" className="bg-ColorFondo rounded-full p-2  transform transition-transform duration-400 hover:scale-105"/>
              </div>

              <div>
                <Parrafos textoParrafo="Peso" className="text-sm font-medium"/>
                <InpuT type="text" className="bg-ColorFondo rounded-full p-2  transform transition-transform duration-400 hover:scale-105"/>
              </div>
              <div>
                <Parrafos textoParrafo="Estado" className="text-sm font-medium"/>
                <InpuT type="text" className="bg-ColorFondo rounded-full p-2  transform transition-transform duration-400 hover:scale-105"/>
              </div>

              <div>
                <Parrafos textoParrafo="Municipio" className="text-sm font-medium"/>
                <InpuT type="text" className="bg-ColorFondo rounded-full p-2 text-center transform transition-transform duration-400 hover:scale-105"/>
              </div>

              <div>
                <Parrafos textoParrafo="Numero de Telefono" className="text-sm font-medium"/>
                <InpuT type="text" className="bg-ColorFondo rounded-full p-2 text-center transform transition-transform duration-400 hover:scale-105"/>
              </div>
            </section>
